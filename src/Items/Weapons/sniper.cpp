...
Sniper::Sniper(QGraphicsItem *parent) :Weapon(parent,
             ":/Items/Weapons/sniper2.png") {

}

void Sniper::mountToParent(double x,double y){
...
void Sniper::setBulletCharacter(){
