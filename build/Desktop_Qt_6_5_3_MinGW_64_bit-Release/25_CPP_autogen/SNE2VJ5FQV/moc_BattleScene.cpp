...
void BattleScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gameOver((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        {
            using _t = void (BattleScene::*)(const QString & );
            if (_t _q_method = &BattleScene::gameOver; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BattleScene::gameOver(const QString & _t1)
{
